 ...
 */
package it.polito.elite.domotics.dog2.modbusnetworkdriver.regxlators;
...
public class RegXlatorBooleanCoil extends RegXlator
{
	...
	/* (non-Javadoc)
	 * @see it.polito.elite.domotics.dog2.modbusnetworkdriver.regxlators.RegXlator#getValue()
	 */
	@Override
