 ...
 * 
 */
public class EchelonIlon100SinglePhaseEnergyMeterDriver implements Driver, ServiceTrackerCustomizer<Object, Object>
{
	...
	public static String logId = "[EchelonIlon100SinglePhaseEnergyMeterDriver]: ";
	...
	private Vector<EchelonIlon100SinglePhaseEnergyMeterDriverInstance> connectedDrivers;
	...
	public EchelonIlon100SinglePhaseEnergyMeterDriver(BundleContext context)
	{
		// init the logger
		...
		this.connectedDrivers = new Vector<EchelonIlon100SinglePhaseEnergyMeterDriverInstance>();
		...
		catch (InvalidSyntaxException e)
		{
			this.logger
					.log(LogService.LOG_ERROR,
							EchelonIlon100SinglePhaseEnergyMeterDriver.logId
	...
	public int match(ServiceReference reference) throws Exception
	{
		...
		if (deviceCategory != null)
		{
			if (manifacturer != null
					...
					&& (deviceCategory.equals(SinglePhaseEnergyMeter.class.getName()) && (this.gateway
							.isGatewayAvailable(gateway))

					))
			{
				matchValue = SinglePhaseEnergyMeter.MATCH_MANUFACTURER + SinglePhaseEnergyMeter.MATCH_TYPE;
			}
	...
	public String attach(final ServiceReference reference) throws Exception
	{
		...
		EchelonIlon100SinglePhaseEnergyMeterDriverInstance driverInstance = new EchelonIlon100SinglePhaseEnergyMeterDriverInstance(
	...
	private void register()
	{
		...
		propDriver.put(DeviceCostants.DRIVER_ID, "EchelonIlon100_SinglePhaseEnergyMeter_driver");
