...
/**
 * The driver for Echelon-based Single Phase Active Power Meters
 * 
 * @author <a href="mailto:dario.bonino@polito.it">Dario Bonino</a>
 * @see <a href="http://elite.polito.it">http://elite.polito.it</a>
 * 
 */
public class EchelonIlon100SinglePhaseActivePowerMeterDriver implements Driver, ServiceTrackerCustomizer<Object, Object>
{
	...
	public static String logId = "[EchelonIlon100SinglePhaseActivePowerMeterDriver]: ";
	...
	private Vector<EchelonIlon100SinglePhaseActivePowerMeterDriverInstance> connectedDrivers;
	...
	String filterQuery2 = String.format("(%s=%s)", Constants.OBJECTCLASS, EchelonIlon100GatewayDriver.class.getName());
	
	/**
	 * The class constructor, builds a new instance of the
	 * EchelonIlon100SinglePhaseActivePowerMeterDriver. It tracks the services
	 * needed to enable the driver in the OSGi framework.
	 * 
	 * @param context
	 */
	public EchelonIlon100SinglePhaseActivePowerMeterDriver(BundleContext context)
	{
		// init the logger
		...
		this.connectedDrivers = new Vector<EchelonIlon100SinglePhaseActivePowerMeterDriverInstance>();
		...
		try
		{
			...
			// this.context.createFilter(filterQuery1), this);
			ServiceTracker<?,?> st2 = new ServiceTracker<Object, Object>(context, this.context.createFilter(filterQuery2), this);
			// open the tracker
			// st.open();
			st2.open();
		}
		catch (InvalidSyntaxException e)
		{
			this.logger
					.log(LogService.LOG_ERROR,
							EchelonIlon100SinglePhaseActivePowerMeterDriver.logId
	...
	public Object addingService(ServiceReference<Object> reference)
	{
		...
		// if (reference instanceof EchelonIlon100GatewayDriver)
		// {
		this.gateway = (EchelonIlon100GatewayDriver) this.context.getService(reference);
		/*
		 * } else if (reference instanceof EchelonIlon100Network) {
		 */
		this.network = this.gateway.getNetwork();// (EchelonIlon100Network)
													// reference;
		// }
		
		// if both references have been filled...register the service
	...
	public int match(ServiceReference reference) throws Exception
	{
		...
		if (deviceCategory != null)
		{
			...
			{
				matchValue = SinglePhaseActivePowerMeter.MATCH_MANUFACTURER + SinglePhaseActivePowerMeter.MATCH_TYPE;
			}
	...
	public String attach(final ServiceReference reference) throws Exception
	{
		...
		final EchelonIlon100SinglePhaseActivePowerMeterDriverInstance driverInstance = new EchelonIlon100SinglePhaseActivePowerMeterDriverInstance(
	...
	private void register()
	{
		...
		propDriver.put(DeviceCostants.DRIVER_ID, "EchelonIlon100_SinglePhaseActivePowerMeter_driver");
