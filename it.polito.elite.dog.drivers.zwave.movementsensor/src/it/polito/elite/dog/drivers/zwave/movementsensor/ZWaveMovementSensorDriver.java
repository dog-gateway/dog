...
public class ZWaveMovementSensorDriver implements Driver, ManagedService
{
	...
	public synchronized int match(ServiceReference reference) throws Exception
	{
		...
		if (deviceCategory != null)
		{
			...
			{
				matchValue = MovementSensor.MATCH_MANUFACTURER
						+ MovementSensor.MATCH_TYPE;
			}
			...
			throws Exception
	{
		...
		ZWaveMovementSensorDriverInstance driverInstance = new ZWaveMovementSensorDriverInstance(
	...
	{
		for (Class<?> devCat : ZWaveMovementSensorDriverInstance.class
				.getInterfaces())
		{
			...
			else
			{
				throw new ConfigurationException(ZWaveInfo.PROPERTY_UPDATETIME,
						ZWaveInfo.PROPERTY_UPDATETIME
								...
								+ ZWaveMovementSensorDriver.class.getName());
			}
