 ...
 * @since May 28, 2013
 */
public class RegXlator2ByteFloatHolding extends RegXlator
{
	
	public RegXlator2ByteFloatHolding()
	{
		super();
		this.typeSize = 2;
	}
	...
	public float fromRegister(Register[] inputRegisters)
	{
		...
		//swap bytes
		byte word[] = inputRegisters[0].toBytes();
	...
	public Register[] toRegister(float value)
	{
		...
		Register registers[] = new SimpleRegister[1];
