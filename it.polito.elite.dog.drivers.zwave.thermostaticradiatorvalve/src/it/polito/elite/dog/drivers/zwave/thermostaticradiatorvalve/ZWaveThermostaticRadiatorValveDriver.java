 ...
 * 
 */
public class ZWaveThermostaticRadiatorValveDriver implements Driver, ManagedService, EventHandler
{
	...
	public synchronized int match(ServiceReference reference) throws Exception
	{
		...
		if ((this.network != null) && (this.gateway != null) && (this.regDriver != null))
		{
			...
			try
			{
				...
				if (Controllable.class.isAssignableFrom(ZWaveThermostaticRadiatorValveDriver.class.getClassLoader()
