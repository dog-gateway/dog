 ...
 *
 */
public class ZWaveThermostaticRadiatorValveDriver implements Driver, ManagedService
{
	...
	public int match(ServiceReference reference) throws Exception
	{
		...
		if (deviceCategory != null)
		{
			if (manifacturer != null && (gateway != null) && (manifacturer.equals(ZWaveInfo.MANUFACTURER))
					&& (thermostaticRadiatorValveDeviceCategories.contains(deviceCategory))
					&& (this.gateway.get().isGatewayAvailable(gateway)))
			{
				matchValue = ThermostaticRadiatorValve.MATCH_MANUFACTURER + ThermostaticRadiatorValve.MATCH_TYPE;
			}
	...
	{
		for (Class<?> devCat : ZWaveThermostaticRadiatorValveInstance.class.getInterfaces())
		{
		...
		if (properties != null)
		{
			...
			else
			{
				throw new ConfigurationException(ZWaveInfo.PROPERTY_UPDATETIME, ZWaveInfo.PROPERTY_UPDATETIME
						...
						+ ZWaveThermostaticRadiatorValveDriver.class.getName());
			}
