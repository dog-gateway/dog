...
public class ModbusCo2SensorDriver implements Driver
{
	...
	public int match(ServiceReference reference) throws Exception
	{
		...
		if (deviceCategory != null)
		{
			if (manifacturer != null && (gateway != null) && (manifacturer.equals(ModbusInfo.MANUFACTURER))
					&& (deviceCategory.equals(Co2Sensor.class.getName()) && (this.gateway.isGatewayAvailable(gateway))
	...
	private void register()
	{
		if ((this.network != null) && (this.gateway != null) && (this.context != null) && (this.regDriver == null))
		{
			...
			propDriver.put(DogDeviceCostants.DRIVER_ID, "Modbus_ModbusCo2Sensor_driver");
