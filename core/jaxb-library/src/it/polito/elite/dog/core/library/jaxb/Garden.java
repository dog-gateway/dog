...
/**
 * <p>
 * Java class for garden complex type.
 * 
 * <p>
...
@XmlType(name = "garden", propOrder = { "description" })
public class Garden implements Cloneable
{
	...
	/**
	 * Creates a new {@code Garden} instance.
	 * 
	 */
	public Garden()
	{
	...
	/**
	 * Creates a new {@code Garden} instance by deeply copying a given
	 * {@code Garden} instance.
	 * 
	 * 
	 * @param o
	 ...
	 */
	public Garden(final Garden o)
	{
		// CC-XJC Version 2.0.1 Build 2012-03-02T12:09:12+0000
		super();
		if (o == null)
		{
			throw new NullPointerException("Cannot create a copy of 'Garden' from 'null'.");
		}
	...
	public Garden clone()
	{
		try
		{
			{
				// CC-XJC Version 2.0.1 Build 2012-03-02T12:09:12+0000
				final Garden clone = ((Garden) super.clone());
				// CBuiltinLeafInfo: java.lang.String
