...
public class DogShutterButton extends AbstractDevice implements ShutterButton
{
	...
	public DogShutterButton(BundleContext context, DeviceDescriptor dogDeviceDescriptor)
	{
		super(context);
	...
	**/
	...
	public void notifyPressedUp(){
		UpNotification notificationEvent=new UpNotification();
	...
	public void notifyPressedDown(){
		DownNotification notificationEvent=new DownNotification();
		notificationEvent.setDeviceUri(this.deviceId);
		// Send the notification through the EventAdmin
		notifyEventAdmin(notificationEvent);
	}
