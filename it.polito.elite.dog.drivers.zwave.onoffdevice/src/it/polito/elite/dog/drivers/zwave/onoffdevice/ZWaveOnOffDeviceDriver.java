...
public class ZWaveOnOffDeviceDriver implements Driver, ManagedService
{
			...
			throws Exception
	{
		...
		ZWaveOnOffDeviceDriverInstance driverInstance = new ZWaveOnOffDeviceDriverInstance(
				network.get(),
				device,
	...
	{
		for (Class<?> devCat : ZWaveOnOffDeviceDriverInstance.class
				.getInterfaces())
		{
			...
			else
			{
				throw new ConfigurationException(ZWaveInfo.PROPERTY_UPDATETIME,
						ZWaveInfo.PROPERTY_UPDATETIME
								...
								+ ZWaveOnOffDeviceDriver.class.getName());
			}
