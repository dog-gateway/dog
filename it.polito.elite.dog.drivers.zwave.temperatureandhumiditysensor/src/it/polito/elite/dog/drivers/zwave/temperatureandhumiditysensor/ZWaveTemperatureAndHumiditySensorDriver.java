...
public class ZWaveTemperatureAndHumiditySensorDriver implements Driver,
		ManagedService
{
	...
	public synchronized int match(ServiceReference reference) throws Exception
	{
		...
		if (deviceCategory != null)
		{
			if (manifacturer != null
					...
					&& (temperatureAndHumidityDeviceCategories
	...
	{
		for (Class<?> devCat : ZWaveTemperatureAndHumiditySensorDriverInstance.class
				.getInterfaces())
		{
			...
			else
			{
				throw new ConfigurationException(ZWaveInfo.PROPERTY_UPDATETIME,
						ZWaveInfo.PROPERTY_UPDATETIME
								...
								+ ZWaveTemperatureAndHumiditySensorDriver.class
										.getName());
			}
