...
public class FrameworkMonitorEndpoint implements FrameworkMonitor
{
	...
	public String getRuntimeMemory()
	{
		...
		{
			this.logger.log(LogService.LOG_WARNING, "Error in creating the JSON object for the runtime memory");
		}
	...
	public String getFreeMemory()
	{
		...
		{
			this.logger.log(LogService.LOG_WARNING, "Error in creating the JSON object for the free memory");
		}
	...
	public String getUsedMemory()
	{
		...
		{
			this.logger.log(LogService.LOG_WARNING, "Error in creating the JSON object for the used memory");
		}
