...
public class ZWaveSinglePhaseElectricityMeterDriver implements Driver,
		ManagedService
{
	...
	public synchronized int match(ServiceReference reference) throws Exception
	{
		...
		if (deviceCategory != null)
		{
			if (manifacturer != null
					...
					&& (singlePhaseElectricityMeterCategories
	...
	{
		for (Class<?> devCat : ZWaveSinglePhaseElectricityMeterInstance.class
				.getInterfaces())
		{
			...
			else
			{
				throw new ConfigurationException(ZWaveInfo.PROPERTY_UPDATETIME,
						ZWaveInfo.PROPERTY_UPDATETIME
								...
								+ ZWaveSinglePhaseElectricityMeterDriver.class
										.getName());
			}
