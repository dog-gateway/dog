 ...
 *       &lt;sequence>
 *         &lt;element name="action" type="{http://elite.polito.it/domotics/dog/rules/rule_definition}aBlock" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Rhs {
     ...
     * 
     */
    public List<ABlock> getAction() {
        if (action == null) {
            action = new ArrayList<ABlock>();
        }
        return this.action;
    }
