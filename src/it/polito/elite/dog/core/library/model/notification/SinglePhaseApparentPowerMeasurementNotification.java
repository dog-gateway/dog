...
public class SinglePhaseApparentPowerMeasurementNotification implements ParametricNotification
{
	public static String notificationName = "newApparentPowerValue";

	public static String notificationTopic="it/polito/elite/domotics/model/notification/SinglePhaseApparentPowerMeasurementNotification";

private String deviceUri;
public String getDeviceUri(){return this.deviceUri;}
public void setDeviceUri(String deviceUri){ this.deviceUri=deviceUri;}
public String getNotificationTopic(){ return SinglePhaseApparentPowerMeasurementNotification.notificationTopic; };
