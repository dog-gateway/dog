...
package it.polito.elite.dog.core.library.model.devicemodel;
 ...
 /**
* DogElectricalSystemModel - automatically generated by DogOnt2Dog
*/
...
public class DogElectricalSystem extends AbstractDevice implements ElectricalSystem
{

	public DogElectricalSystem(BundleContext context, DeviceDescriptor dogDeviceDescriptor)
	{
		super(context);
	...
	{
		if(this.driver!=null){
		return ((ElectricalSystem) this.driver).getState();
		}
		 return null;
	}
