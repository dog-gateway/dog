...
public class MultiTariffThreePhaseActiveEnergyMeasurementNotification implements ParametricNotification
{
	...
	public static String notificationTopic="it/polito/elite/domotics/model/notification/MultiTariffThreePhaseActiveEnergyMeasurementNotification";

private String deviceUri;
public String getDeviceUri(){return this.deviceUri;}
public void setDeviceUri(String deviceUri){ this.deviceUri=deviceUri;}
public String getNotificationTopic(){ return MultiTariffThreePhaseActiveEnergyMeasurementNotification.notificationTopic; };
