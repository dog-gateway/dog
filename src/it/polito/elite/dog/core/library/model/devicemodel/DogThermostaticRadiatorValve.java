		...
		ThermostaticRadiatorValve
{
	...
	public DogThermostaticRadiatorValve(BundleContext context,
	...
	public void setDaySchedule(Object[] switchPoints, Integer weekDay)
	{
		if (this.driver != null)
		{
			((ThermostaticRadiatorValve) this.driver).setDaySchedule(
					switchPoints, weekDay);
		}
	}
	...
	public Object[] getDaySchedule(Integer weekDay)
	{
		if (this.driver != null)
		{
			return ((ThermostaticRadiatorValve) this.driver)
	...
	public void setTemperatureAt(Measure<?, ?> temperature)
	{
		if (this.driver != null)
		{
			((ThermostaticRadiatorValve) this.driver)
					.setTemperatureAt(temperature);
		}
	}
