...
package it.polito.elite.dog.core.library.model.devicemodel;
 ...
 /**
* DogWaterMeterModel - automatically generated by DogOnt2Dog
*/

import it.polito.elite.dog.core.library.model.DeviceStatus;
import it.polito.elite.dog.core.library.model.AbstractDevice;
import it.polito.elite.dog.core.library.model.DeviceDescriptor;
import it.polito.elite.dog.core.library.model.devicecategory.WaterMeter;
...
public class DogWaterMeter extends AbstractDevice implements WaterMeter
{

	public DogWaterMeter(BundleContext context, DeviceDescriptor dogDeviceDescriptor)
	{
		super(context);
	...
	{
		if(this.driver!=null){
		return ((WaterMeter) this.driver).getAmountOfColdWaterInM3();
		}
		 return null;
	}
	...
	{
		if(this.driver!=null){
		return ((WaterMeter) this.driver).getState();
		}
		 return null;
	}
	...
	{
		if(this.driver!=null){
		return ((WaterMeter) this.driver).getAmountOfHotWaterInM3();
		}
		 return null;
	}
