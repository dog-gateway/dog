...
package it.polito.elite.dog.core.library.model.devicemodel;
 ...
 /**
* DogHomeGatewayModel - automatically generated by DogOnt2Dog
*/
...
public class DogHomeGateway extends AbstractDevice implements HomeGateway
{

	public DogHomeGateway(BundleContext context, DeviceDescriptor dogDeviceDescriptor)
	{
		super(context);
	...
	{
		if(this.driver!=null){
		return ((HomeGateway) this.driver).getState();
		}
		 return null;
	}
