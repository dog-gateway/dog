...
public class MultiTariffSinglePhaseReactiveEnergyMeasurementNotification implements ParametricNotification
{
	public static String notificationName = "newReactiveEnergyValue";

	public static String notificationTopic="it/polito/elite/domotics/model/notification/MultiTariffSinglePhaseReactiveEnergyMeasurementNotification";

private String deviceUri;
public String getDeviceUri(){return this.deviceUri;}
public void setDeviceUri(String deviceUri){ this.deviceUri=deviceUri;}
public String getNotificationTopic(){ return MultiTariffSinglePhaseReactiveEnergyMeasurementNotification.notificationTopic; };
