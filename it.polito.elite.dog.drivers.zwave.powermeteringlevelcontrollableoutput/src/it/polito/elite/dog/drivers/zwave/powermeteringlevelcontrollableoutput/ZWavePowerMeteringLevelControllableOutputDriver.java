...
public class ZWavePowerMeteringLevelControllableOutputDriver implements Driver, ManagedService
{
	...
	public synchronized int match(ServiceReference reference) throws Exception
	{
		...
		if ((this.network != null) && (this.gateway != null) && (this.regDriver != null))
		{
			...
			try
			{
				...
				if (Controllable.class.isAssignableFrom(ZWavePowerMeteringLevelControllableOutputDriver.class
						.getClassLoader().loadClass(deviceCategory)))
				{
					...
					if (deviceCategory != null)
					{
						...
						{
							matchValue = PowerMeteringLevelControllableOutput.MATCH_MANUFACTURER
									+ PowerMeteringLevelControllableOutput.MATCH_TYPE;
						}
					}
	...
	public synchronized String attach(ServiceReference reference) throws Exception
	{
		...
		ZWavePowerMeteringLevelControllableOutputDriverInstance driverInstance = new ZWavePowerMeteringLevelControllableOutputDriverInstance(
	...
	private void properFillDeviceCategories()
	{
		...
		{
			this.powerMeteringLevelControllableDeviceCategories.add(devCat.getName());
		}
	}
